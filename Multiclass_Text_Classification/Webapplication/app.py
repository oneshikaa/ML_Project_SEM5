...
model = joblib.load('C:\\Users\\vans9\\OneDrive\\Desktop\\thapar sem 5\\ML_Project_SEM5\\Multiclass_Text_Classification\\Notebook\\Text_LR.pkl')
count_vec = joblib.load('C:\\Users\\vans9\\OneDrive\\Desktop\\thapar sem 5\\ML_Project_SEM5\\Multiclass_Text_Classification\\Notebook\\count_vect.pkl')
transformer = joblib.load('C:\\Users\\vans9\\OneDrive\\Desktop\\thapar sem 5\\ML_Project_SEM5\\Multiclass_Text_Classification\\Notebook\\transformer.pkl')
...
def send_email():
    ...
    server.starttls()
    server.login('vans98961@gmail@gmail.com', 'valb mmmn awhg snpd')
    
    server.sendmail('vans98961@gmail@gmail.com', 'vans98961@gmail@gmail.com', subject + '\n\n' + body)
    server.quit()
